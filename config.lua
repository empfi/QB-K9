...
-- Dog Settings
Config.DogModel = 'a_c_husky' -- Dog model to use
...
-- Movement Settings
Config.MaxTeleportDistance = 30.0 -- Maximum distance before dog teleports to player
...
-- Attack Settings
Config.MaxAttackDistance = 50.0 -- Maximum distance to attack target before aborting
